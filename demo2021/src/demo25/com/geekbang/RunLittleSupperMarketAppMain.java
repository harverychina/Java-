package demo25.com.geekbang;

import demo25.com.geekbang.person.Customer;
import demo25.com.geekbang.supermarket.LittleSuperMarket;
import demo25.com.geekbang.supermarket.Merchandise;
...
public class RunLittleSupperMarketAppMain {
    public static void main(String[] args) {
        ...
        littleSuperMarket.incomingSum = 200;
//        200种商品
        ...
        while (open) {
            ...
            if (customer.isDrivingCar) {
                if (littleSuperMarket.parkingCount > 0) {
                    ...
                    System.out.println("不好意思，本店车位已满。欢迎你下次光临");
                    continue;
                }
            } else {
            ...
            while (true) {
                ...
                System.out.println("您选购的商品名字" + m.name + "。单位是" + m.soldPrice + "。请问您要购买多少个？");
        ...
        for (int i = 0; i < littleSuperMarket.merchandiseSold.length; i++) {
            ...
            if (numSold > 0) {
//                double incomming = m.soldPrice * numSold * numSold;
                double incomming = m.soldPrice * numSold;
                double netIncomming = (m.soldPrice - m.purrchasePrice) * numSold;
